...
type
  ...
  public
    FUltimaMessagem: String;
    FTimeUltimaMensagem: TDateTime;
//    property OnGetDescModulo: TFuncGetDescModulo;
//    property OnGetDescControl: TFuncGetDescControl;
    constructor Create;
    /// <summary>
    ...
    /// </summary>
    class procedure MyLog(const psMessage: string; aControler: Tobject; const aIDErro: Integer;
    ...
    /// </summary>
    class procedure MyLogTemp(const psMessage: string; aControler: Tobject; const aIDErro: Integer;
     const pbShowError: Boolean = False; const ACriticalLog: TCriticalLog = tlERROR; const psName: String = 'log'); Overload;
...
class function TLog.FileSize(const FileName: String): LongInt; var SearchRec : TSearchRec;
begin
...
class function TLog.GetDescCriticalLog(const ACriticalLog: TCriticalLog): String;
begin
...
function WriteFile(const psFilePath: string; var poText: TStringList; const pbClearFile: Boolean): Boolean;
var
  vArq: TextFile;
  vIndex: Integer;
  sDirectory: string;
